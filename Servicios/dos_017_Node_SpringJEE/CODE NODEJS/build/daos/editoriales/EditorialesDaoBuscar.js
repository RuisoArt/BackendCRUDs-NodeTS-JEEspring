...
class EditorialesDaoBuscar {
    static encontrarEditorial(sqlBuscar, parametros, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield conexionDataBase_1.default.one(sqlBuscar, parametros)
                .then((dato) => {
                console.log(dato);
...
exports.default = EditorialesDaoBuscar;
