...
"devindex": "nodemon build/index.js" --> ejecuta nodemon y contrulle un archivo de salida (por donde entran los los usuarios) llamado index.js
"buildtsc": "tsc -w" --> transpila a typescript
...
Abrir elarchivo tsconfig.json:
    ...
    "outDir": "./buildTsc", -->  descomentar y dirigir a la carpeta donde queremos que guarde la Transpilacion
