...
class UsuDaoActualizar{

    public static async actualizarUsuario(sqlActualizar:string, parametros:any, res:Response):Promise<any>{
...
export default UsuDaoActualizar;