...
----------------------------------------------- Alertas
INSERT INTO alertas(cod_usuario, dias_alerta, meses_alerta, titulo_alerta, detalle_alerta, estado_alerta, fecha_alerta) 
    VALUES ('1', '4', '5', 'Ingreso al almacen', 'El Programador tiene hambre y no ha desayunado', '1','2022-03-16');
INSERT INTO alertas(cod_usuario, dias_alerta, meses_alerta, titulo_alerta, detalle_alerta, estado_alerta, fecha_alerta)
    VALUES ('2', '2', '3', 'Vio las tortillas', 'El Programador tiene hambre y no ha desayunado', '1','2022-03-16');
INSERT INTO alertas(cod_usuario, dias_alerta, meses_alerta, titulo_alerta, detalle_alerta, estado_alerta, fecha_alerta)
    VALUES ('3', '6', '5', 'Se antojo de un taco', 'El Programador tiene hambre y no ha desayunado', '1','2022-03-16');
INSERT INTO alertas(cod_usuario, dias_alerta, meses_alerta, titulo_alerta, detalle_alerta, estado_alerta, fecha_alerta)
    VALUES ('4', '8', '9', 'compro las tortillas', 'El Programador tiene hambre y no ha desayunado', '1','2022-03-16');
INSERT INTO alertas(cod_usuario, dias_alerta, meses_alerta, titulo_alerta, detalle_alerta, estado_alerta, fecha_alerta)
    VALUES ('5', '1', '1', 'se fue a hacerce un taco al pastor', 'El Programador tiene hambre y no ha desayunado', '1','2022-03-16');
...
INSERT INTO ingresos(cod_usuario, fecha_ingreso, hora_ingreso) VALUES ('1','2022-03-16', '08:33:00');
INSERT INTO ingresos(cod_usuario, fecha_ingreso, hora_ingreso) VALUES ('2','2022-03-16', '08:33:00');
INSERT INTO ingresos(cod_usuario, fecha_ingreso, hora_ingreso) VALUES ('3','2022-03-16', '08:33:00');
INSERT INTO ingresos(cod_usuario, fecha_ingreso, hora_ingreso) VALUES ('4','2022-03-16', '08:33:00');
INSERT INTO ingresos(cod_usuario, fecha_ingreso, hora_ingreso) VALUES ('5','2022-03-16', '08:33:00');