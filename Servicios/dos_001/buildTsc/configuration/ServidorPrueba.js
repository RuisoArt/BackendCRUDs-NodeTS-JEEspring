...
const PruebaRutas_1 = __importDefault(require("../rutes/PruebaRutas"));
class ServidorPrueba {
    ...
    activarRutas() {
        this.app.use('/api/buscaNemo', PruebaRutas_1.default); // los usuarios puede ir a la ruta de Dori por medio de la ruta
    }
    iniciarServidor() {
